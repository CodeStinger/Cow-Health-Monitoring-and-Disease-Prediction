    ...
    <header id="header">
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
               ...
               <%--      <a class="navbar-brand" href="<%=request.getContextPath()%>/JSP/Homepage.jsp"><img src="<%=request.getContextPath()%>/images/logo2.jpeg" alt="logo"></a>
   --%>              </div>
				
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                  	<li ><a href="Portal.jsp"><font
						color="#3C91E6">Get Sensor value</font> </a></li>
						
							<li ><a href="tableformat.jsp"><font
						color="#3C91E6">Table Format</font> </a></li>
						<li ><a href="viewdisease.jsp"><font
						color="#3C91E6">Predict Disease</font> </a></li>
				<%-- <li><a href="<%=request.getContextPath()%>/viewRealtime.jsp"
					class="green-text"><strong><font color="#3C91E6">View Realtime Data</font> </strong> </a></li>
			 --%>	<li><a href="Changepassword.jsp"><font color="#3C91E6">Change
							Password</font> </a></li>
				<li><a href="Login.jsp"><font color="#3C91E6">Logout</font>
				</a></li>                  
                    </ul>
                </div>
            </div><!--/.container-->
